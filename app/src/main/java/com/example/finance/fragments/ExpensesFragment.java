...
public class ExpensesFragment extends Fragment {
    ...
    private MyViewModelExp viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView rubles = view.findViewById(R.id.textView5_exp);
        ...
        viewModel = new ViewModelProvider(this).get(MyViewModelExp.class);
        ...
        ImageButton btn = view.findViewById(R.id.imageButton_exp);
    ...
    private void CreateStats(List<Double> mas, @NonNull View view){
        ...
        entries.add(new PieEntry(mas.get(0).floatValue(), "Развлечения"));
        entries.add(new PieEntry(mas.get(1).floatValue(), "Продукты"));
        entries.add(new PieEntry(mas.get(2).floatValue(), "Одежда"));
        entries.add(new PieEntry(mas.get(3).floatValue(), "Такси"));
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            Log.i("ads", String.valueOf(entry.formColor) + colors[i]);
